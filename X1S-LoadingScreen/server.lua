...
local versionUrl = "https://raw.githubusercontent.com/X1Studios/X1Studios-Loading-Screen/main/version.txt"
...
local function CheckForUpdates()
    PerformHttpRequest(versionUrl, function(statusCode, responseText, headers)
        ...
        if latestVersion == currentVersion then
            ...
            print("^5Download:^0 https://github.com/X1Studios/X1Studios-Loading-Screen")
            print("^3-------------------------------------------------------^0")
        end
    end, "GET")
end
